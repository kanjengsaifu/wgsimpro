  ...
  */
  class Datatables
  {
    ...
    */
    ...
    //CHAIRUL
    //02-05-2016
    public function like($key_condition, $val = NULL, $persen = 'both')
    {
      //$this->where[] = array($key_condition, $val, $backtick_protect);
      $this->ci->db->like($key_condition, $val, $persen); 
      return $this;
    }
    //CHAIRUL
    //02-05-2016
    public function order_by($field_name, $ordered_by = 'ASC')
    {
      $this->ci->db->order_by($field_name, $ordered_by);
      return $this;
    }
