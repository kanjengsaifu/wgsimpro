            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <table class="table table-bordered mbn">
                        ...
                        ?>
                                <td class="text-center pn" style="vertical-align: top">
                                    <div class="panel">
                                        <div class="panel-heading bg-success2">
                                            <span class="panel-title"><?=$ktower?></span>
                                        </div>
                                        <div class="panel-body pn">
                                            <table class="table table-bordered mbn">
                                                <tbody>
                                                <?php
                                                foreach($vtower as $klantai => $vlantai) {
                                                ?>
                                                    <tr>
                                                        <td style="background-color: #ece7f9; border: solid 1px #000"><?=$klantai?></td>
                                                        <?php
                                                        foreach($vlantai as $kunit => $vunit) {
                                                            $style = 'background-color: #d9f1d5; cursor: pointer;';
                                                            $class = 'td-unit';
                                                            if($vunit['ishold']==='1') {
