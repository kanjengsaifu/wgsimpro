            ...
            <div class="panel mbn">
                <div class="panel-body">
                    <ul class="nav nav-pills mb20">
                        <li class="active">
                            <a href="#tabnew" data-toggle="tab">New</a>
                        </li>
                        <li>
                            <a href="#tabretrieve" data-toggle="tab">Retrieve Data Reserve</a>
                        </li>
                    </ul>
                    <div class="tab-content br-n pn">
                        <div id="tabnew" class="tab-pane active">
                        ...
                        <div id="tabretrieve" class="tab-pane">

                            <table class="table table-striped table-bordered table-hover" id="datatable-ret" cellspacing="0" width="100%">
                                <thead>
                                    <tr class="bg-primary light bg-gradient">
                                        <th>No. Unit</th>
                                        <th>Nama Customer</th>
                    ...
                    <div id="panel-payment-plan-item1" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" action="javascript:" id="form-payment">
                                ...
                                <input type="hidden" id="status_tr" name="status_tr" value="BOOKING"/> 
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-lg-3 control-label">Tgl. Ra.Akad Kredit</label>
                                    <div class="col-lg-3">
                                        <input type="text" name="tgl_akad" id="tgl_akad" class="form-control input-sm" value="<?=date('d/m/Y')?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Tgl. Penyerahan Bangunan</label>
                                    <div class="col-lg-3">
                                        <input type="text" name="tgl_bangunan" id="tgl_bangunan" class="form-control input-sm" value="<?=date('d/m/Y')?>">
                                    </div>
                                    <label class="col-lg-2 control-label">No. Pesanan</label>
                                    <div class="col-lg-4"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3"> 
                                        <select id="peruntukan" name="peruntukan" class="chosen-select">
                                            <option value=""></option>
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" name="peruntukan_lain" id="peruntukan_lain" class="form-control input-sm">
                                    </div>
                                </div> 
                                <div class="form-group">
                                ...
                                <input type="hidden" id="pkode_pay"/>
...
<div class="row mt20 text-center">
    ...
    <div class="col-md-2">
        <button type="button" id="btn-reserve" class="btn btn-primary btn-gradient dark btn-block">Submit Booking</button>
    </div>
</div>
