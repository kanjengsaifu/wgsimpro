	                	...
	                	<div class="form-group"> 
	                        ...
	                        <table width="100%">
		                        ...
		                        <tr>
		                        	...
		                        	<td class="text-left">
		                        		<table width='60%'>
		                        			<td style="width: 80%;"><label id='last_nobuk1' name='last_nobuk1' class="text-uppercase"></td>
		                        			<td  class="text-left"><div id='last_nobuk1'></div><!--button width='100%' type="button" id="btn-cetak-vcr" name="btn-cetak_vcr" class="btn btn-sm btn-success btn-block"><i class="fa fa-print"></i>&nbsp;&nbsp;&nbsp;Voucher</button--></td>
