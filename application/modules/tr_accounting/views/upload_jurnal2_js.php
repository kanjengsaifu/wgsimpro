    ...
    $(document).ready(function()
    {
        ...
        $('#btn_upload').on('click',function(){
            if($('.input-periode').val()==''){
                ...
                alert('Anda belum menyertakan file attachment untuk diupload.');
            }else{
                var periode = $('#periode').val();
                var url = "<?=base_url()?>index.php/jurnal/upload/";
                //alert(url+periode);
                $('#f_upload_jurnal').attr('action', url+periode);
                $('#f_upload_jurnal').submit();
            }
        });
