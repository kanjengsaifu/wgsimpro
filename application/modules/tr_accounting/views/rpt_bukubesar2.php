					...
					<table id="t_bukubesar" class="table table-bordered mbn export2excel">
						...
						?>
							<tr id="<?=$v['kode_coa']?>" bgcolor="#FFCC66;">
								<td class="text-center"><a class="tangan" onclick="show_child('<?=$v['kode_coa']?>','<?=$data['peuriode']?>')"><span id="spn_<?=$v['kode_coa']?>" class="fa fa-chevron-down"></span></a></td>
							...
							<?=tr_bukbes($v['kode_coa'],$data['peuriode'],$data['kde_div'],$v['saldo'],'sub_'.$v['kode_coa'],'','class="'.$subclas.'"')?>
