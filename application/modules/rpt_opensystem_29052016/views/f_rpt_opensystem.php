            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <table id="example" class="table table-bordered mbn export2excel">
                        ...
                        <tbody>
                        <?php
                            foreach($data['gt'] as $row => $ve){
                                $gt_terbit += $ve['penerbitan'];
                                $gt_lunas += $ve['pelunasan'];
                                $gt_sisa += $ve['sisa'];
                            }
                            $t_terbit =0;
                            $t_lunas =0;
                            ...
                            foreach ($data['rows'] as $k => $v) {
                                ...
                                if($isSubTotal==12){
                                    ...
                                    $gtterbit += number_format($v['penerbitan']);
                                    $gtlunas += number_format($v['pelunasan']);
                        ...
                        ?>
                           ...
                           //}
                            if($isSubTotal==12){
                                if($v['label']==='B'){
                                    $ter =number_format($v['penerbitan']);
                                    $t_ter += $ter;
                                }
                        ...
                        <tfoot>
                            <tr class="bg-primary light">
                                ...
                                <th class="text-right"><?=number_format($gt_terbit)?></th>
                                <th class="text-right"><?=number_format($gt_lunas)?></th>
                                <th class="text-right"><?=number_format($gt_sisa)?></th>
