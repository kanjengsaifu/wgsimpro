                ...
                <div class="panel-body" id="pnlbody">
                    <form class="form-horizontal" role="form" action="javascript:" id="form-input">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-lg-1">
                                <div class="radio-custom square radio-success mb5">
                                  <input type="radio" id="jenis1" name="angkut_id" value="1" checked="checked">
                                  <label for="jenis1">Iya</label>
                                </div>
                            </div>
                            <div class="col-lg-1">
                                <div class="radio-custom square radio-primary mb5">
                                  <input type="radio" id="jenis2" name="no_surat_jalan" value="2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-2">
                            <?php $tglbapb = isset($data['naskon']['tanggal'])?$data['naskon']['tanggal']:''; 
