                ...
                <div class="panel-body">
                	<form class="form-horizontal" role="form" action="javascript:" id="form-input">
                		...
                		<div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <select id="kode_sbdaya" name="kode_sbdaya" class="chosen-select">
									<option value=""></option>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Volume Rolling</label>
                            <div class="col-lg-4">
                                <input type="text" name="volume_rev" id="volume_rev" class="form-control input-sm">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Volume Proyeksi</label>
                            <div class="col-lg-4">
                                <input type="text" name="volumepry" id="volumepry" class="form-control input-sm">
                            </div>
                        </div>
                        <div class="form-group">
