        ...
        <div class="col-md-12 pn">
            <div class="panel">
                <div class="panel-body">
                	<form class="form-horizontal" method="post" action="<?=base_url()?>index.php/rab-btl-excel/save" id="form-ui" enctype="multipart/form-data">
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <a href="<?=base_url()?>assets/download/rab_btl_format.xls"><button type="button" class="btn btn-success btn-gradient dark btn-block">Download</button></a>
                            </div>
                        </div>
