					...
					<table id="example" class="table table-bordered mbn">
						<thead>
							<tr class="bg-primary light">
								...
								<th rowspan="3" class="text-center" style="vertical-align:middle">Tower</th>
								...
								<th colspan="7" class="text-center">KEKURANGAN PEMBAYARAN</th>
							</tr>
							<tr class="bg-primary light">
								<!-- RA -->
								<th class="text-center" rowspan="2" style="vertical-align:middle">Uang Muka</th>
								<th class="text-center" rowspan="2" style="vertical-align:middle">%</th>
								<th class="text-center" rowspan="2" style="vertical-align:middle">Angsuran</th>
								<th class="text-center" rowspan="2" style="vertical-align:middle">%</th>
								...
								<th class="text-center" rowspan="2" style="vertical-align:middle">%</th>
								<!-- KEKURANGAN -->
								<th class="text-center" colspan="3">Uang Muka</th>
								<th class="text-center" colspan="3">Angsuran</th>
								<th class="text-center" rowspan="2" style="vertical-align:middle">TOTAL</th>
							</tr>
							<tr class="bg-primary light">
						...
						?>
							<tr>
								...
								<td class="text-center"><?=number_format($ri_um/$bruto*100,2)?></td>
								<td class="text-right"><?=number_format($ri_ag,2)?></td>
								<td class="text-center"><?=number_format($ri_ag/$bruto*100,2)?></td>
								<td class="text-right"><?=number_format($ri_ag+$ri_um,2)?></td>
								<td class="text-center"><?=number_format(($ri_ag+$ri_um)/$bruto*100,2)?></td>
								<td class="text-right"><?=number_format($kr_ra_um1,2)?></td>
								<td class="text-right"><?=number_format($kr_ra_um2,2)?></td>
								<td class="text-right"><?=number_format($kr_ra_um3,2)?></td>
								<td class="text-right"><?=number_format($kr_ra_ag1,2)?></td>
								<td class="text-right"><?=number_format($kr_ra_ag2,2)?></td>
								<td class="text-right"><?=number_format($kr_ra_ag3,2)?></td>
						...
						<?php 
							...
							<tr class="bg-primary light">
								...
								<td class="text-center">&nbsp;</b></td>
								<td class="text-right"><b><?=@number_format($sumKRUM1,2)?></b></td>
								<td class="text-right"><b><?=@number_format($sumKRUM2,2)?></b></td>
								<td class="text-right"><b><?=@number_format($sumKRUM3,2)?></b></td>
								<td class="text-right"><b><?=@number_format($sumKRAG1,2)?></b></td>
								<td class="text-right"><b><?=@number_format($sumKRAG2,2)?></b></td>
								<td class="text-right"><b><?=@number_format($sumKRAG3,2)?></b></td>
