					...
					<table id="example" class="table table-bordered mbn">
						...
						<?php 
							...
							foreach ($vtype as $kkode => $vkode) {
								...
								$theN = isset($vkode['unit']['N'])?$vkode['resvr']['N']:0; //Jumlah status Reserve
						...
						<?php 
								...
								$theJ = isset($vkode['ra_unit']['F'])?$vkode['ra_unit']['F']:0;
								$theK = 0;
								$theN = isset($vkode['netto_rsv']['N'])?$vkode['netto_rsv']['N']:0;
						...
						<?php 
								...
								$theJ = isset($vkode['ra_unit']['F'])?$vkode['ra_unit']['F']:0;
								$theK = 0;
								$theN = isset($vkode['gross_rsv']['N'])?$vkode['gross_rsv']['N']:0;
