                ...
                <div class="panel-body">
                    ...
                    <table id="example" class="table table-bordered mbn export2excel">
                        ...
                        <tr>
                            ...
                            <!-- Terhadap RAB -->
                            <td class="text-right"><?=number_format($row->rab_vol-$row->vol_mov)?></td>
                            <td class="text-right"><?=number_format($row->rab_price-$row->price_mo)?></td>
                        </tr>
                        <?php
                        ...
                        $_priceVsRAB += $row->rab_price-$row->price_mo;
                        $n++;
                        }
                        ?>
                        </tbody>
                        <tfoot>
                            <tr class="bg-primary light text-bold">
                                ...
                                <td class="text-right"></td>
                                <td class="text-right"></td>
                                <td class="text-right"><?=number_format($_priceMOV)?></td>
                                <td class="text-right"></td>
