...
$route['bapb/delete_sd/(:num)'] 		= 'tr_bapb/delete_sd/$1';
...
$route['jurnal/listNoBukx']				= 'tr_tools/getListNoBuktiWithBlank';
$route['jurnal/listNoBuk2']				= 'tr_tools/getListUnsedNoBuk';
$route['jurnal/listNoBuk/(:any)']				= 'tr_tools/getListNoBuk/$1';
$route['jurnal/listViewNoBuk/(:any)']				= 'tr_tools/getListViewNoBuk/$1';
$route['jurnal/get_ghostnobuk/(:any)/(:any)']	= 'tr_accounting/get_listnobuk/$1/$2';
$route['jurnal/cek_dentry']				= 'tr_accounting/cek_double_entry';
...
* REKENING KORAN
*/
$route['rpt/rk'] 									= 'rpt_rekeningkoran/f_periode';
$route['rpt/rk/(:any)'] 							= 'rpt_rekeningkoran/generateReport/$1';
...
$route['mail/brcs/(:any)']  					= 'mail_notification/broadcast/$1';
$route['mail/send/(:num)']  					= 'mail_notification/mail_satuan/$1';
$route['mail/mailer']  							= 'mail_notification/mailer';
$route['notifikasi']  							= 'Notifikasi';
$route['notifikasi/(:any)']  					= 'Notifikasi/index/$1';

//broadcast SMS
$route['sms/brcs']								= 'Sms_app/broadcast';
$route['sms/sendAll']							= 'Sms_app/kirim_pesan';
$route['sms/send/(:num)']						= 'Sms_app/kirim_pesan/$1';
...
//BKS 28/04
$route['coa_common']							= 'tr_tools/coa_common';
$route['gen_coacom']							= 'tr_accounting/autoupdate_coacommon';//'tr_tools/updateCoaCommon';
