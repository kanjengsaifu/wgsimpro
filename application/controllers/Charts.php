...
class Charts extends CI_Controller {
	...
	{		
		...
		$this->highcharts->set_title('INTERNET WORLD USERS BY LANGUAGE', 'Top 6 Languages in 2016'); // set chart title: title, subtitle(optional)
	...
	* Output data as array on json string
	...
	function _data()
	{
		$data['users']['data'] = array(536564837, 444948013, 153309074, 99143700, 82548200, 506564837);
		$data['users']['name'] = 'Users by Language';
		$data['popul']['data'] = array(1277528133, 1365524982, 420469703, 126804433, 250372925, 975524982);
		$data['popul']['name'] = 'World Population';
		$data['axis']['categories'] = array('English', 'Chinese', 'Spanish', 'Japanese', 'Portuguese', 'Indonesia');
